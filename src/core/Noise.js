// Seeded PRNG + 2D simplex noise. Everything procedural in the world derives
// from here, so the same seed always produces the same map.
...
export class Simplex {
  ...
  fbm(x, y, octaves, baseFreq, lacunarity, persistence) {
    let amp = 1;
    let freq = baseFreq;
    let sum = 0;
    let norm = 0;
